...
- 회피 방법
  - 이런 유형의 오류는 제품을 시장에 내놓기 전에 제품 출시를 위한 Checklist 항목으로 Source Code를 공개를 관리함으로 피할 수 있다. 
- 유형 및 내용
  - 잘못된 Version의 동반 Source Code 제공
- 회피 방법
  - Binary version에 맞는 동반 Source Code의 제공을 보장하기 위한 확인 단계를 Compliance Process에 추가함으로 이런 유형의 오류를 피할 수 있다. 
- 유형 및 내용
  - 수정한 FOSS Component에 대한 동반 Source Code 제공 실패
- 회피 방법
  - FOSS Component의 원본 Source Code가 아닌 수정한 Source Code의 제공을 보장하기 위한 확인 단계를 Compliance Process에 추가함으로 이런 유형의 오류를 피할 수 있다. 
...
> License Compliance 관련 위험
- 유형 및 내용
  - FOSS Source Code의 수정 내용 표시 실패
    - FOSS Source Code가 수정되었음을 표시하지 않거나 수정사항에 대한 설명을 포함하지 않음
- 회피 방법
  - 이런 유형의 오류는 다음의 방법을 통해 피할 수 있다. 
    1. Source Code 수정 사항 표시 과정을 Source Code를 공개 전 확인 단계에 추가
    2. 개발자들이 일반 대중에게 공개할 예정인 모든 FOSS 혹은 Proprietary Software에 대해 Copyright 표시 및 License 정보 update를 수행할 수 있도록 교육 제공
...
- 예방 방법
  - 이런 유형의 오류는 다음 방법을 통해 예방할 수 있다. 
    1. Software Platform에 대해 정기적으로 Full Scan을 수행하여 확인되지 않은 FOSS 사용을 발견한다. 
    2. 개발자에게 회사의 FOSS 정책 및 Process에 대해 교육을 제공한다. 
    3. 직원 성과 검토 시 Compliance 항목을 추가한다. 
- 내용
  - FOSS 교육을 수강하지 않음
- 회피 방법
...
- 회피 방법
  - 이런 유형의 오류는 Audit 보고서가 완료되지 않은 경우, 문제가 해결되었다는 Compliance 증명서를 발급하지 않음으로 피할 수 있다. 
- 예방 방법
...
- 기업은 (어떤 형태로든) 제품 출하 이전에 Compliance를 우선시하여 지켜야 한다. 
...
> Community 관계 확립
- 상용 제품에 FOSS를 사용하는 기업이라면 FOSS Community (특히, 제품에 사용 및 배포하는 FOSS Project와 관계된 FOSS Community) 와 좋은 관계를 유지하는 것이 가장 좋다. 
- 게다가, FOSS 기관과의 좋은 관계는 Compliance를 지키기 위한 최선의 방법에 대한 도움을 받을 수 있고, Compliance 이슈가 발생할 경우 도움이 된다. 
